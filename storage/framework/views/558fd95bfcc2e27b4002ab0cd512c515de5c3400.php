    ...
    <div id="projeto-besouro-carousel" class="carousel slide" style="width: 50%; margin: auto" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="<?php echo e(asset('img/software-de-gerenciamento-de-projetos.jpg')); ?>" alt="Gerente planejando o projeto.">
                <div class="carousel-caption">
                    Gerenciamento de projetos mais inteligente com o planejamento dinâmico.
                </div>
            </div>
            <div class="item">
                <img src="<?php echo e(asset('img/foco-didatico.png')); ?>" alt="Foco didático para o ensino de gerenciamento de projetos.">
                <div class="carousel-caption">
                    Gerenciamento de projetos com um foco mais didático.
                </div>
            </div>
            <div class="item">
                <img src="<?php echo e(asset('img/open-source.png')); ?>" alt="Ferramentas open source.">
                <div class="carousel-caption">
