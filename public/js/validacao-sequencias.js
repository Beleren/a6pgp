$(function() {
    ...
    function habilitarSalvarDetalhesRecursos() {
        ...
        $('#form-detalhes-recursos').submit(function() {
            $('#botaoEnviarDetalhesRecursos').trigger('click');
        });
    }
    ...
    function habilitarSalvarDetalhesAtividades() {
        ...
        $('#form-detalhes').submit(function() {
            $('#botaoEnviarDetalhes').trigger('click');
        });
    }
    ...
    function obterDetalhesDeSequenciaDoServidor(atividade_id) {
        ...
        if (isNaN(cenario_id) === true) {
            cenario_id = $('#cenario option:selected').attr('value');
        }
